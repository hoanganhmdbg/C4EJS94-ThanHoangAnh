...
console.log("jobTitle, locations, skills, jobSalary and benefitValues of ALL job hits");
for(let a of jobData.hits){
    console.log(`Title: ${a.jobTitle}`);
    console.log(`Salary : ${a.jobSalary} $`);
    console.log("Location :");
    for(let b of a.locations){
        console.log(`- ${b}`);
    }
    console.log("Benefit:");
    for(let c of a.benefits){
        console.log(`- ${c.benefitValue}`);
    }
    console.log("Skill :");
    for(let d of a.skills){
        console.log(`- ${d.value}`);
    }
